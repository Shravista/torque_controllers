...
def generate_launch_description():
    urdf_file_name = 'iiwa_description/urdf/iiwa14.urdf'
    rviz_file_name = 'config/common.rviz'
    ...
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            ...
            launch_arguments=[('gz_args', [arg_gz_world, ' -v 4 default.sdf', ' -r'])]
    )
    ...
    load_joint_position_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'active', 'iiwa14_effort_controller'],
        output='screen'
    )
